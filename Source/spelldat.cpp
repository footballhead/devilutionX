...
SpellData spelldata[] = {
	...
	// Blood ritual notes: implementation was adapted from PR Demo
	// There is no MIS_BLODRIT (spells work differently in PR Demo), so DevilutionX MIS_HEAL was used as a template with decompiled PR Demo code substituted in
